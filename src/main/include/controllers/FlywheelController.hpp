...
public:
     ...
     */
    void SetMeasuredAngularVelocity(double angularVelocity);
     ...
     */
    double AngularVelocityGoal() const;
...
private:
    ...
    frc::LinearSystem<1, 1, 1> m_plant = frc::IdentifyVelocitySystem(
        Constants::Flywheel::kV, Constants::Flywheel::kA);
